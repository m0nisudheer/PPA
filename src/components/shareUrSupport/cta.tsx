        ...
        <div className="flex items-center gap-3 rounded-xl border border-[#E5E7EB] p-4">
          ...
          <div className="flex flex-col gap-3 flex-1">
            ...
            <div>
              <a
                href="#"
                className="inline-flex items-center gap-1.5 self-start rounded-md bg-[#1B7339] px-3 py-2 text-[12px] font-bold uppercase tracking-wide text-white hover:bg-[#145f2f] transition-colors"
              >
          ...
          <div className="flex flex-col gap-3 flex-1">
            <div>
              ...
              <p className="text-[13px] text-[#6B7280]">
                Thank you for being a part of this movement. Together, we can
                grow champions and change lives.
              </p>
            </div>
            <div>
              <a
