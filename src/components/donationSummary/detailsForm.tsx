...
const inputClass = (hasError?: boolean) =>
  `w-full h-10 rounded-md border px-3
   ...
   font-inter text-[16px] font-normal text-[#111827] placeholder:font-inter placeholder:font-normal placeholder:text-[#9CA3AF] placeholder:text-[13px]
   ${hasError ? "border-red-400" : "border-gray-200"}`;

  return (
    <div className="border-2 border-[#F3F4F6] p-4 md:p-6 rounded-2xl flex flex-col gap-6">
      <div className="flex flex-col gap-2">
        <h3 className="text-[22px] font-semibold md:text-[28px] leading-none tracking-normal text-[#111827]">
          Your Details
        </h3>

        <p className="text-[15px] md:text-[18px] leading-5 md:leading-7 text-[#6B7280]">
        ...
        >
          <div className="grid md:grid-cols-2 gap-4">
            <div className="flex flex-col gap-1 h-20">
              <label className="text-sm text-[#374151] tracking-normal leading-[100%] text-[16px]">
  ...
  <div
    className={`flex h-10 overflow-hidden rounded-md border transition focus-within:border-[#6BB643] focus-within:ring-2 focus-within:ring-[#6BB643]/20 ${
      errors.mobile ? "border-red-400" : "border-gray-200"
    }`}
  >
    <span className="flex items-center border-r border-gray-200 bg-gray-50 px-3 text-[12px] md:text-[16px] font-normal text-[#6B7280]">
      🇮🇳 +91
    </span>
    ...
    <input
      ...
      className="flex-1 bg-white px-3 font-inter text-[16px] font-normal text-[#111827] placeholder:font-inter placeholder:text-[16px] placeholder:font-normal placeholder:text-[#9CA3AF] outline-none"
    />
  </div>
