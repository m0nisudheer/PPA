...
export default function Banner() {
  ...
  return (
    <div className="pt-20 lg:h-screen flex flex-col">
      <div
          ...
          <div className="grid w-full items-center gap-4 md:gap-8 lg:gap-12 xl:grid-cols-2">
            <div className="flex flex-col gap-4 md:gap-7 text-white">
              <div className="flex flex-col gap-3 md:gap-4 2xl:gap-6">
                <h3 className="font-semibold uppercase leading-[130%] 2xl:leading-[120%] tracking-normal text-[34px] md:text-[48px] xl:text-[50px] 2xl:text-[66px]">
                ...
                <p className="text-[18px] md:text-[24px] lg:text-[20px] 2xl:text-[26px]  xl:leading-[34px] tracking-normal">
              ...
              <div className="flex flex-wrap gap-4">
                {features.map((feature, index) => (
                  <button
                    ...
                    className={`inline-flex cursor-pointer items-center gap-2 rounded-md px-2 py-1 md:px-5 2xl:px-6 2xl:py-2 text-[14px] md:text-[15px] 2xl:text-[16px] font-normal transition-all duration-300 ${
                      index === 0
      ...
      <div className="relative z-20 w-full px-3 py-5 md:hero">
        <div className="-mt-12 2xl:-mt-18 rounded-2xl bg-[#222D4E] shadow-2xl">
            ...
            {stats.map((item, index) => {
              ...
              return (
                ...
                >
                  ...
                  <Icon
                    className="h-7 w-7 shrink-0 text-[#70AA44] md:h-8 md:w-8 2xl:h-9 2xl:w-9"
                    strokeWidth={2}
                  />

                  <div className="flex flex-col gap-1 text-center md:text-left">
                    <h3 className="text-[#FFFFFF] text-[24px] 2xl:text-[28px] leading-[100%] tracking-normal">
                      {item.value}
                    </h3>

                    <p className="text-[16px] 2xl:text-[18px] text-[#FFFFFF]">
                      {item.label}
                    </p>
                  </div>
                </div>
