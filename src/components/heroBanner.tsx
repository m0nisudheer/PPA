...
export default function Banner() {
  return (
    ...
    >
      <div className="relative z-10 mx-auto flex h-[calc(100%-5rem)] items-center">
        <div className="grid w-full items-center gap-8 lg:gap-12 lg:grid-cols-2">
          <div className="flex flex-col gap-7 text-white">
            <div className="flex flex-col gap-4 xl:gap-6">
              <h3 className="font-semibold uppercase leading-none text-[42px] md:text-[58px] lg:text-[50px] xl:text-[70px]">
                DONATE <span className="text-[#6F962C]">NOW</span>
              </h3>

              <div className="flex flex-col gap-2">
                <h1 className="text-[25px] font-medium uppercase leading-tight md:text-[36px] lg:text-[25px] xl:text-[42px]">
              ...
              <p className="text-[20px] md:text-[24px] lg:text-[20px] xl:text-[26px]  xl:leading-[34px] tracking-normal">
            ...
            <div className="flex flex-wrap gap-8 lg:gap-14">
              {features.map((feature) => {
                ...
                return (
                  ...
                  >
                    <div className="flex h-14 w-14 md:h-16 md:w-16 lg:h-14 lg:w-14 items-center justify-center rounded-full border border-[#2E8B3D] bg-[#0D2A4F]">
                      <Icon className="h-6 w-6 md:h-8 md:w-8 lg:h-6 lg:w-6 text-[#2E8B3D]" />
                    </div>

                    <span className="text-[14px] md:text-[18px] xl:text-[16px] leading-5 tracking-normal">
                      {feature.title}
                      <br />
                      {feature.subtitle}
                    </span>
