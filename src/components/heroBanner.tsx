  ...
  return (
    <div
      ...
      style={{
        ...
        // https://res.cloudinary.com/dg8zhu8fq/image/upload/v1782914824/ywg0i8vm8nyfzsc8czae.jpg
           backgroundImage: `
      linear-gradient(
        to right,
        rgba(0, 0, 0, 0.8) 0%,
      ...
      url('https://res.cloudinary.com/dg8zhu8fq/image/upload/f_auto,q_auto:good,w_1920,c_limit/v1782914824/ywg0i8vm8nyfzsc8czae.jpg')
    `, }}
    >
        ...
        <div className="grid w-full items-center gap-4 md:gap-8 lg:gap-12 lg:grid-cols-2">
          <div className="flex flex-col gap-4 md:gap-7 text-white">
            <div className="flex flex-col gap-4 xl:gap-6">
              <h3 className="font-semibold uppercase leading-none text-[42px] lg:text-[50px] 2xl:text-[70px]">
                DONATE <span className="text-[#6F962C]">NOW</span>
              </h3>

              <div className="flex flex-col gap-2">
                <h1 className="text-[22px] font-medium uppercase leading-tight md:text-[25px] 2xl:text-[42px]">
              ...
              <p className="text-[18px] md:text-[20px] 2xl:text-[26px]  2xl:leading-[34px] tracking-normal">
            ...
            <div className="flex flex-wrap gap-8 2xl:gap-14">
              {features.map((feature) => {
                ...
                return (
                  ...
                  >
                    <div className="flex h-10 w-10 md:h-11 md:w-11 2xl:h-14 2xl:w-14 items-center justify-center rounded-full border border-[#2E8B3D] bg-[#0D2A4F]">
                      <Icon className="h-4 w-4 md:h-6 md:w-6 2xl:h-8 2xl:w-8 text-[#2E8B3D]" />
                    </div>

                    <span className="text-[14px] 2xl:text-[16px] leading-5 tracking-normal">
                      {feature.title}
                      <br />
                      {feature.subtitle}
                    </span>
